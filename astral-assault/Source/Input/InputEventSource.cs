...
namespace AstralAssault
{
    public static class InputEventSource
    {
        ...
        private static void HandleKeyboard() {
            ...
            if (_keysDown.Count == 0) _prevKeysDown.Clear();
            ...
            foreach (Keys key in _keysDown) {
                ...
                if (!_prevKeysDown.Contains(key)) keysPressed.Add(key);
            }
        ...
        private static void HandleMouseMovement() {
            ...
            if (_mousePos != _prevMousePos) MouseMoveEvent?.Invoke(null, new MouseMoveEventArgs(_mousePos));
        }
    }
}